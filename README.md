...
![Robotron 2000 Badge](https://img.shields.io/badge/Status-Conclu%C3%ADdo-brightgreen)
...
* **Atualização de Atributos:** Cada peça altera dinamicamente as estatísticas de Força, Poder, Energia e Velocidade do robô.
* **Controle de Inventário:** Implementei uma lógica de validação para impedir que o número de peças seja inferior a zero, garantindo a integridade dos cálculos das estatísticas.
